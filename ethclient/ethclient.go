...
// SubscribeNewPending subscribes to notifications about the pending transactions
// on the given channel.
func (ec *Client) SubscribeNewPending(ctx context.Context, ch chan<- interface{}) (ethereum.Subscription, error) {
